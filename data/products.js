...
export function getProductWithId(productId) {
  let matchingProduct;
...
export class Clothing extends Product{
  ...
  constructor(productDescription) {
    ...
    this.sizeChartLink = productDescription.sizeChartLink;
  }
...
export function loadProductsFetch() {
  ...
  const promise = fetch('https://supersimplebackend.dev/products')
    ...
    .then( response => {
      products = response.map((productDescription) => {
        return productDescription.type === 'clothing'
        ? new Clothing(productDescription)
...
export function loadProducts( fun ) {
  ...
  xhr.addEventListener('load', () => {
    products = JSON.parse(xhr.response).map((productDescription) => {
